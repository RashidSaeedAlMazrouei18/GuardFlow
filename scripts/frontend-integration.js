 ...
 * This file demonstrates how to integrate Guardflow with a web frontend
 */

// For React/Vue/Angular applications
export class GuardflowClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GuardflowClient(provider, contractAddress);
